...
@XmlRootElement(name="contactShareGroup")
public class ContactShareGroup extends BaseApiBean {
  ...
  public List<ReferenceBean> getContactShareQueues() {
     return this.contactShareQueues;
  }
  ...
  public static class ContactShareGroupList extends BaseApiListBean<ContactShareGroup> {
