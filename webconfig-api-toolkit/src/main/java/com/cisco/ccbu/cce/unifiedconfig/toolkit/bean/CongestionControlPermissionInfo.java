...
public class CongestionControlPermissionInfo extends BaseApiBean {
  private Boolean canChangeDeploymentType;
  ...
  public Boolean getCanChangeDeploymentType() {
     return this.canChangeDeploymentType;
  }
