...
@XmlRootElement(name="enterpriseRoute")
public class EnterpriseRoute extends BaseApiBean {
  ...
  public static class EnterpriseRouteList extends BaseApiListBean<EnterpriseRoute> {
