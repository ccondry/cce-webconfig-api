...
public class LogicalInterfaceController extends BaseApiBean {
  ...
  public static class LogicalInterfaceControllerList extends BaseApiListBean<LogicalInterfaceController> {
    @XmlElementWrapper(name = "pgs")
    @XmlElement(name = "pg")
    public List<LogicalInterfaceController> getItems() {
      return items;
    }

    public void setItems(List<LogicalInterfaceController> items) {
      this.items = items;
    }
  }
}
