...
public class EnterpriseSkillGroupList extends BaseApiBean {
  ...
  @Path("enterpriseroute")
  @XmlRootElement(name = "results")
  public static class EnterpriseSkillGroupListList extends BaseApiListBean<EnterpriseSkillGroupList> {
    @XmlElementWrapper(name = "resultss")
    @XmlElement(name = "results")
    public List<EnterpriseSkillGroupList> getItems() {
      return items;
    }

    public void setItems(List<EnterpriseSkillGroupList> items) {
      this.items = items;
    }
  }
}
