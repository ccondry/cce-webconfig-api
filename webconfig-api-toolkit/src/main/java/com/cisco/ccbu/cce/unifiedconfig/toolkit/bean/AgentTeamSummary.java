...
@Path("/agentteam")
@XmlRootElement(name="agentTeamSummary")
public class AgentTeamSummary extends BaseApiBean {
  ...
  public static class AgentTeamSummaryList extends BaseApiListBean<AgentTeamSummary> {
    @XmlElementWrapper(name = "agentTeamSummarys")
    @XmlElement(name = "agentTeamSummary")
    public List<AgentTeamSummary> getItems() {
      return items;
    }

    public void setItems(List<AgentTeamSummary> items) {
      this.items = items;
    }
  }
}
